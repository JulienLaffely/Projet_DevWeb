    ...
    var xhttp7 = new XMLHttpRequest();
          xhttp7.onreadystatechange = function() {
            if(xhttp7.readyState == 4 && xhttp7.status == 200){
              var convocations = JSON.parse(xhttp7.response);
          ...
          xhttp7.open("GET","Convocations.json",false);
          xhttp7.send();
}
    ...
    var xhttp6 = new XMLHttpRequest();
          xhttp6.onreadystatechange = function() {
            if(xhttp6.readyState == 4 && xhttp6.status == 200){
              var convocations = JSON.parse(xhttp6.response);
              convocations.forEach(function(ligne){
                if(ligne['date']==document.getElementsByName('dateConvoc')[0].value)
                {
          ...
          xhttp6.open("GET","Convocations.json",false);
          xhttp6.send();
}
    ...
    var xhttp5 = new XMLHttpRequest();
          xhttp5.onreadystatechange = function() {
            if(xhttp5.readyState == 4 && xhttp5.status == 200){
              var convocations = JSON.parse(xhttp5.response);
              convocations.forEach(function(ligne){
                if(ligne['date']==document.getElementsByName('dateConvoc')[0].value)
                {
          ...
          xhttp5.open("GET","Convocations.json",false);
          xhttp5.send();
}
